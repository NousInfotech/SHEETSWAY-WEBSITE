    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 items-center justify-center ">
        ...
        <Button
          ...
          style={{ backgroundColor: "#E8840C", color: "#fff" }}
        >
          Contact Us
        </Button>
      </div>
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-32 md:gap-24 gap-10  lg:mt-24 md:mt-10">
          <div className="col-span-1 flex flex-col gap-4 ">
            ...
            <div className="flex gap-4 mt-10">
              <button className="w-fit bg-[#e8840c] rounded-xl text-white">
              ...
              <button className="w-fit border border-[#e8840c] rounded-xl text-secondary">
                <div className="flex font-normal lg:p-8 lg:py-4 sm:p-6 sm:py-2 p-4 py-1.5 text-left flex-col">
                  <p className="sm:text-sm text-xs opacity-50 text-[#e8840c]">Email Us</p>
                  <p className="lg:text-lg text-base text-[#e8840c]">info@sheetsway.com</p>
                </div>
              </button>
            </div>
          </div>

...
const solutions = [
  ...
  },
  {
    ...
    bgImage: "/navbar-solutions/word-plugin.jpg"
  },
  {
    label: "Workspace",
    ...
    bgImage: "/navbar-solutions/excel-plugin.jpg"
  },
  {
    label: "Client Portal",
    ...
    bgImage: "/navbar-solutions/client-connect.jpg"
  },
];
...
export default function Navbar() {
  ...
  // Find the active solution based on the current pathname
  const activeSolution = solutions.find(sol => sol.href === pathname);
              ...
              <NavigationMenuContent>
                <ul className="grid gap-3 p-4 md:w-[500px] lg:w-[700px] lg:grid-cols-[.75fr_1fr] bg-white">
                  <li className="row-span-3">
                    <NavigationMenuLink asChild>
                      {activeSolution ? (
                        <div className="flex h-full w-full select-none flex-col justify-between rounded-md bg-gradient-to-b from-muted/50 to-muted p-2 no-underline outline-none gap-2 focus:shadow-md overflow-hidden">

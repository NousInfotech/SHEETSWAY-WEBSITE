...
const IntegrationPage = () => {
  return (
    ...
    <div className="px-2 py-10 sm:px-14 flex flex-col items-center">
      ...
      <FadeUpAnimation>
        <div className="mb-8">
          <button className="bg-orange-500 text-white font-bold py-2 px-6 rounded-full text-sm uppercase tracking-wide">
            Our Tools
          </button>
        </div>
      </FadeUpAnimation>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-20 md:gap-6 w-full">
        {/* Word Plugin Section */}
        <Plugin
          linkName={"Drafting"}

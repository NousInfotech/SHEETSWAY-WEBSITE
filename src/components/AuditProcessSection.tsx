        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <div className="max-w-6xl mx-auto mb-20">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-orange-200 transform lg:translate-y-12 transition-all duration-300 hover:bg-gradient-to-br hover:from-yellow-400 hover:to-orange-400 hover:text-white group">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-orange-200 transition-all duration-300 hover:bg-gradient-to-br hover:from-orange-400 hover:to-orange-400 hover:text-white group">
                <div className="w-12 h-12 bg-orange-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-white transition-all duration-300">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-orange-200 transform lg:translate-y-12 transition-all duration-300 hover:bg-gradient-to-br hover:from-orange-400 hover:to-orange-400 hover:text-white group">
                <div className="w-12 h-12 bg-orange-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-white transition-all duration-300">

...
export default function IndustryAwareAI() {
  ...
  useEffect(() => {
    ...
    const id = setTimeout(() => {
      setActive((prev) =>
        prev === industryAwareData.length - 1 ? 0 : prev + 1
      );
    }, timeoutMs);
  ...
  const BottomDivider = () => (
    <div className="absolute left-0 right-0 bottom-0 w-screen h-10 -mb-5">
      <div className="h-full w-full bg-gradient-to-b from-transparent via-white-100 to-gray-100/30 shadow-2xl">
        <div className="absolute inset-0 bg-gradient-to-r from-primary/10 via-orange-100/30 to-primary/10" />
              ...
              <div key={index} className="relative mb-5">
                  ...
                  <div className="absolute left-0 top-2 bottom-0 flex">
                    <div className="w-1 bg-primary rounded">
                      <div
                        ...
                        style={{
                          animationDuration: `${
                            Number.isFinite(industryAwareData[index]?.duration) &&
                ...
                <div className="pl-3 flex flex-col justify-between">
                  ...
                  >
                    {el.title}{" "}
                    {el.tag && (
                      <span className="text-base font-semibold">({el.tag})</span>
                    )}
                  </h2>
                  {active === index && (

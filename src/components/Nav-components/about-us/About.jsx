...
import Heading from "@/Components-1/UI/Heading";
import { ChevronRight } from "lucide-react";
import Image from "next/image";
import Link from "next/link";
import { CiLinkedin, CiMail } from "react-icons/ci";
import { badges, team } from "../../../app/_constants/about-us-data";
        ...
        <div className="sm:my-24 my-10 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 px-10">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-4 md:gap-6 lg:gap-8">
            {badges.map((badge, index) => (
              ...
              >
                <div className="relative w-8 h-8 scale-125 bg-[#FFE6D1] rounded-full z-10 flex items-center justify-center transition-colors duration-500 ease-in-out">
                  {badge.leftSection}
                </div>
                ...
                <div
                  className="absolute inset-0 bg-[#e8840c] rounded-3xl scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-700 ease-in-out"

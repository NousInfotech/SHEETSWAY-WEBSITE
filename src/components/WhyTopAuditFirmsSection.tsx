  ...
  const features = [
    {
      ...
      description:
        "Manage clients, documents, and communication from a fully remote, centralized audit portal.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Track every file, task, and deadline with our modern, organized dashboard designed for stress-free audits.",
    },
  ];
    ...
    <section className="py-8 sm:py-12 lg:py-24 relative overflow-hidden bg-white">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="space-y-8 sm:space-y-12">
          {/* Constrained Width: Tag, Heading, and Paragraph */}
          <div className="space-y-4 sm:space-y-6 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
              ...
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                Whether you&apos;re a solo practitioner or part of a growing
                firm, Sheetsway helps you simplify audit work, grow your reach,
                and collaborate with ease. All done from one secure online
                platform.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
            ...
            <div className="relative w-full lg:w-auto lg:mt-10 lg:-ml-25">
              <Image
                src={assets.Year2006MarketplacePng}
                alt="Laptops showing audit work"
                width={1400}
                height={1200}
                className="object-contain w-full max-w-2xl mx-auto lg:max-w-none lg:w-[800px]"
              />
            </div>
                ...
                <div className="space-y-8 sm:space-y-12 lg:space-y-16">
                  {features.map((feature, index) => (
                    <div
                      ...
                      className={
                        index === 0
                          ? "relative lg:mt-22 lg:ml-2"
                          : index === 1
                          ? "relative lg:-mt-2 lg:ml-5"
                          : "relative lg:-mt-7 lg:ml-5"
                      }
                    >
          ...
          >
            <div className="relative h-full p-6 sm:p-8 lg:p-12">
              ...
              <div className="flex flex-col lg:flex-row h-full items-center justify-between lg:justify-between relative z-20">
                {/* Left Side - Content */}
                <div className="text-center lg:w-1/2 space-y-4 lg:space-y-6 mb-6 lg:mb-0">
                  <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white leading-tight">
                    We power remote audits with structure & scale
                  </h3>
                  <p className="text-white/90 text-base sm:text-lg leading-relaxed">
                    From solo auditors to full firms, Sheetsway <br/> gives you the
                    tools to manage clients, <br/> proposals, and workflows
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center lg:items-end space-y-4 lg:space-y-0 relative">
                  ...
                  <div className="relative w-80 h-80 sm:w-64 sm:h-64 lg:w-[520px] lg:h-[520px] order-3 lg:order-none lg:absolute lg:right-10 lg:-top-65 lg:h-[202px] -mb-15 lg:mb-0 -ml-8 lg:ml-0">
                    <Image

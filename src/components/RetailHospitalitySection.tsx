...
const RetailHospitalitySection = () => {
  return (
    <section className="py-20 px-0 lg:px-4 flex items-center justify-center min-h-[400px]">
      <div className="container mx-auto flex items-center justify-center">
        {/* Background Container with specified dimensions and radius */}
        <div 
          style={{ backgroundColor: '#E8840C' }} 
          className="w-full lg:max-w-[1800px] h-auto lg:h-[300px] mx-auto lg:rounded-lg px-6 lg:px-12 py-8 lg:py-0 flex items-center justify-center"
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full">
            {/* Left Content */}
            <div className="text-white flex flex-col justify-center">
              <h2 className="text-xl lg:text-2xl font-bold mb-4 lg:mb-4 leading-tight text-left">
                Retail, Hospitality & Service Companies
              </h2>
              <p className="text-xs lg:text-sm mb-6 leading-relaxed opacity-90 text-left">
              ...
              <button 
                className="inline-flex items-center text-xs lg:text-sm gap-3 bg-white font-semibold px-4 py-3 rounded-lg hover:bg-gray-100 transition-colors duration-300 w-fit self-start"
                style={{ color: '#E8840C' }}
              >
                Learn More
                <svg 
